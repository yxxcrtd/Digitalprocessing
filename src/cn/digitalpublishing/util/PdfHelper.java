...
public class PdfHelper {
	 ...
	 * textMark("清华大学  192.168.1.108", 50, "127.0.0.1",
	 * "D:/tmp/9780000000019_110.pdf", "D:/tmp/9780000000019_110_water.pdf",
	 * Color.GRAY, "STSong-Light", "UniGB-UCS2-H", BaseFont.EMBEDDED); String
	 * path = "D:/metadata/9781613501306_water.pdf";
	 ...
	 * @throws Exception
	 */
	public static void textMark(String watermark, float fontSize, String ip,
			String sourceFile, String targetFile, Color color, String fontName,
			String encoding, boolean embedded) throws Exception {
		try {
			// 待加水印的文件
			...
			for (int i = 1; i < total; i++) {
				...
				content.showTextAligned(Element.ALIGN_CENTER, watermark, width,
						high, 35);// 水印文字成35度角倾斜

				// 同时添加IP地址
				content.showTextAligned(Element.ALIGN_BOTTOM, ip, width + 10,
						high / 2, 35);
				content.endText();
				content.saveState();
			}
	...
	/**
	 * According to the original pdf file to create a new pdf file, the new pdf
	 * can be part of the original pdf file
	 * 
	 * @param sourceFile
	 *            Path of original pdf file
	 * @param targetFile
	 *            Path of new pdf file
	 * @param ranges
	 *            A range of pages, example 1-20
	 */
	public static void copyPdf(String sourceFile, String targetFile,
			String ranges) throws Exception {
		try {
	 ...
	 * @throws IOException
	 */
	public static void createHTML(String savePath, String content,
