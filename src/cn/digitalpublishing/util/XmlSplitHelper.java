...
public class XmlSplitHelper {
	 ...
	 * @throws Exception 
	 */
	public void split(String filePath,String root,String targetDir) throws Exception{
		try{
			SAXReader reader = new SAXReader();
			FileInputStream fis = new FileInputStream(filePath);
			XmlSplitHander addHandler = new XmlSplitHander(root,targetDir);
			if(results!=null){
...
//			reader.setFeature(feature, false);
	...
	public Element getPubElement(String filePath,String pubEl){
		Element pub = null;
		try{
...
//		Element pub = helper.getPubElement("e:/test/test.xml", "/ONIXMessage");
//		list.add(pub);
//		helper.split("e:/test/test.xml","/source/temp","/ONIXMessage","RecordReference",list,"ONIXMessage");
