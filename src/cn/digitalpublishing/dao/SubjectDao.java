...
public class SubjectDao extends CommonDao<BSubject, String> {
	...
	private Map<String,Object> getWhere(Map<String,Object> map){
		 ...
		 * parentcode
		 */
		if(CollectionsUtil.exist(map, "parentcode")&&!"".equals(map.get("parentcode"))){
			if(flag==0){
			...
			condition.add(map.get("parentcode").toString().trim());
		}
		/**
		 * code
		 */
        ...
        if(CollectionsUtil.exist(map, "name")&&!"".equals(map.get("name"))){
            ...
            condition.add(map.get("name").toString().trim());
        }
	...
	public List<BSubject> getSubList(Map<String,Object> condition,String sort)throws Exception{
		...
		Map<String,Object> t=this.getWhere(condition);
		String property="id,nameEn,code,name,type,order,desc,treeCode,standard" +
				",parentSubject.id,parentSubject.name,treeCode,isParent,parentSubject.treeCode,parentSubject.order";
		String field="a.id,a.nameEn,a.code,a.name,a.type,a.order,a.desc,a.treeCode,a.standard" +
				",b.id,b.name,a.treeCode,(select cast(count(*) as int ) from BSubject c where c.parentSubject.id=a.id),b.treeCode,b.order";
		try{
			list=super.hibernateDao.getListByHql(property,field, hql+t.get("where"),((List<Object>)t.get("condition")).toArray(),sort, BSubject.class.getName());
		}catch(Exception e){
			throw e;
	...
	public List<BSubject> getPagingList(Map<String,Object> condition,String sort,Integer pageCount,Integer page)throws Exception{
		...
		String field="a.id,a.nameEn,a.code,a.name,a.type,a.order,a.desc,a.treeCode,a.standard" +
				",b.id,b.name,a.treeCode,(select cast(count(*) as int ) from BSubject c where c.parentSubject.id=a.id),b.treeCode,b.order";
		try{
			list=super.hibernateDao.getListByHql(property,field, hql+t.get("where").toString(), ((List<Object>)t.get("condition")).toArray(),sort, BSubject.class.getName(),pageCount,page);
		}catch(Exception e){
			throw e;
		}
		return list;
	...
	*/
	...
	public boolean updateSubjectBySql(BSubject obj)throws Exception{
		...
		try {
			...
			sql.append("update BC_B_SUBJECT set ");
