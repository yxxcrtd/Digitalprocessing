...
CKFinder.lang['zh-cn'] =
{
	...
	FilesDelete	: '你确定要删除  %1 文件?', // MISSING
	FilesLoading	: '加载中...',
	FilesEmpty		: '空文件夹',
	...
	BasketRemoveConfirmMultiple	: '你确定要把  %1 文件移除?', // MISSING
	BasketEmpty			: '临时文件夹为空, 可拖放文件至其中。',
	BasketCopyFilesHere	: '从临时文件夹复制至此',
	BasketMoveFilesHere	: '从临时文件夹移动至此',

	// Global messages
	OperationCompletedSuccess	: '操作完成！成功：', // MISSING
	OperationCompletedErrors		: '操作完成！错误：', // MISSING
	FileError				: '%s: %e', // MISSING

	// Move and Copy files
	MovedFilesNumber		: '移动的文件数量: %s.', // MISSING
	CopiedFilesNumber	: '复制的文件: %s.', // MISSING
	MoveFailedList		: '下列文件无法移动:<br />%s', // MISSING
	CopyFailedList		: '下列文件无法复制:<br />%s', // MISSING
	...
	300 : '移动文件失败。',
	301 : '复制文件失败。',
	500 : '因为安全原因，文件不可浏览. 请联系系统管理员并检查相应的配置文件。',
	501 : '不支持缩略图方式。'
	},
	...
	ErrorMsg :
	{
		...
		FolderExists	: '文件 %s 已存在。', // MISSING
		FolderNameExists	: '文件夹已存在。', // MISSING
	...
	Zip :
	{
		...
		downloadZipLabel	: '下载 zip', // MISSING
		compressZipLabel	: '压缩成 zip', // MISSING
		removeAndExtract	: 'Remove existing and extract', // MISSING
		extractAndOverwrite	: '覆盖现有文件', // MISSING
