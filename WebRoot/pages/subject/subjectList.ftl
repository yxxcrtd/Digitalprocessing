...
<html xmlns="http://www.w3.org/1999/x html">
	...
	<body>
							...
							<form id="form" commandName="form" action="manager" class="form-horizontal">
								<div class="row-fluid">
									<div class="control-group span3">
										<label class="control-label" for="form-field-2">分类法名称：</label>
										<div class="controls">
		...
		<script type="text/javascript" src="${request.contextPath}/pages/subject/subjectListInit.js"></script>
	</body>
</html>
