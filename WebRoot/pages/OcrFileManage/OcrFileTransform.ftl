	...
	<head>
		...
		<script type="text/javascript">
			jQuery(document).ready(function(){
				jQuery("#ocrFileTransformForm").validationEngine();
			});
		</script>
	</head>
	<body>
			...
			<div id="page-content" class="clearfix">
				<div class="row-fluid">
					<div class="page-header position-relative">
						<h1>Ocr文件<small> <i class="icon-double-angle-right"></i>&nbsp;&nbsp;导出</small></h1>
					</div>
					<div class="row-fluid">
						...
						<form id="ocrFileTransformForm" commandName="form" class="form-horizontal" action="transformSubmit">
							<div class="on-down">
								<div class="control-group" id="fileNameDiv">
									...
									<div class="controls">
										<select id="formatFlag" name="formatFlag" data-validation-engine="validate[required]" class="span6" value="">
