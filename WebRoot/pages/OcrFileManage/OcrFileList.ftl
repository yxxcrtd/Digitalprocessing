...
<html xmlns="http://www.w3.org/1999/x html">
	...
	<body>
			...
			<div id="page-content" class="clearfix">
				<div class="row-fluid">
					<div class="row-fluid">
						...
						<div class="on-down">
							<form id="form" commandName="OcrFileForm" action="manager" class="form-horizontal">
								<div class="row-fluid">
									<div class="control-group span3">
										<label class="control-label" for="form-field-2">文件名：</label>
										<div class="controls">
										 	<input id="query_fileName" class="span10" onkeydown="if (13 == event.keyCode) { $('.btn-success').focus(); }"/>
										</div>
									</div>
								</div>
		...
		<script type="text/javascript" src="${request.contextPath}/pages/OcrFileManage/OcrFileListInit.js"></script>
