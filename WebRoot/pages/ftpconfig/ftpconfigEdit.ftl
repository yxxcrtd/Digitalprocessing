	...
	<head>
		...
		<script type="text/javascript">
			jQuery(document).ready(function(){
				jQuery("#FtpConfigFormEdit").validationEngine();
			});
		</script>
	</head>
	<body>
			...
			<div id="page-content" class="clearfix">
				<div class="row-fluid">
					<div class="page-header position-relative">
						<h1>FTP配置信息<small> <i class="icon-double-angle-right"></i>&nbsp;&nbsp;修改</small></h1>
					</div>
					<div class="row-fluid">
						<div class="table-header on">基本信息</div>
						<form id="FtpConfigFormEdit" commandName="form" class="form-horizontal">
							<div class="on-down">
								<div class="control-group" id="identDiv">
									<label class="control-label"><span class="red">*&nbsp</span>标识：</label>
									<div class="controls">
										<input class="span6" data-validation-engine="validate[required,custom[onlyLetterSp]]" id="ident" name="obj.ident" value="${form.obj.ident!}"  />
								...
								<div class="control-group" id="ftpNameDiv">
									...
									<div class="controls">
										<input class="span6" data-validation-engine="validate[required]" id="ftpName" name="obj.ftpName" value="${form.obj.ftpName!}"  />
										<span id="contentSpan" class="help-inline"></span>
									</div>
								</div>
								<div class="control-group" id="ipDiv">
									...
									<div class="controls">
										<input class="span6" data-validation-engine="validate[required,custom[ipv4]]" id="ip" name="obj.ip" value="${form.obj.ip!}"  />
										<span id="contentSpan" class="help-inline"></span>
									</div>
								</div>
								<div class="control-group" id="portDiv">
									...
									<div class="controls">
										<input class="span6" data-validation-engine="validate[required],custom[onlyNumberSp],max[65535]" id="port" name="obj.port" value="${form.obj.port!}" />
										<span id="contentSpan" class="help-inline"></span>
									</div>
								</div>
								<div class="control-group" id="contentDiv">
									...
									<div class="controls">
										<input class="span6" data-validation-engine="validate[required]" id="username" name="obj.username" value="${form.obj.username!}"  />
										<span id="contentSpan" class="help-inline"></span>
									</div>
								</div>
								<div class="control-group" id="fontDiv">
									...
									<div class="controls">
										<input id="font" data-validation-engine="validate[required]" class="span6" name="obj.password"  value="${form.obj.password!}" />
