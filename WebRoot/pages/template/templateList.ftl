...
<html xmlns="http://www.w3.org/1999/x html">
	...
	<body>
					...
					<div class="row-fluid">
					    <div class="ace-thumbnails">
							...
							<button class="btn btn-small btn-primary" onclick="addObj();">
								<i class="icon-plus-sign bigger-125"></i>新建模板
							</button>
						</div>
							...
							<form id="form" commandName="FtpFolderForm" action="manager" class="form-horizontal">
								<div class="row-fluid">
									<div class="control-group span3">
										<label class="control-label" for="form-field-2">模板名称：</label>
										<div class="controls">
										 	<input id="query_name"  class="span10" onkeydown="if (13 == event.keyCode) { $('.btn-success').focus(); }"/>
										</div>
									</div>
								</div>
		...
		<script type="text/javascript" src="${request.contextPath}/pages/template/templateListInit.js"></script>
	</body>
</html>
