			...
			<div id="page-content" class="clearfix">
				<div class="row-fluid">
					<div class="page-header position-relative">
						<h1>标引信息<small> <i class="icon-double-angle-right"></i>&nbsp;&nbsp;修改</small></h1>
					</div>
					<div class="row-fluid">
						<div class="table-header on">基本信息</div>
						<form id="xmlnodeCol" commandName="form" class="form-horizontal">
							<div class="on-down">
								<div class="control-group" id="identDiv">
									<label class="control-label">标引：</label>
									<div class="controls">
										<input name="nodeKey" id="nodeKey" value="${form.obj.nodeKey!}"/>
							...
							<div class="form-actions" style="text-align: center; padding-left:0px;">
								<button class="btn btn-success" type="button" onclick="xmlnodecolsubmit();" id="save"><i class="icon-save bigger-110"></i> 保存</button>&nbsp; &nbsp; &nbsp;
