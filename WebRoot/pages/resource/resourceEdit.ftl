			...
			<div id="page-content" class="clearfix">
				<div class="row-fluid">
					<div class="page-header position-relative">
						<h1>源数据管理<small> <i class="icon-double-angle-right"></i>&nbsp;&nbsp;<#if form.id==null>新建</#if><#if form.id?? >修改</#if></small></h1>
					</div>
					<div class="row-fluid">
						<div class="table-header on">基本信息</div>
						<form id="resourceform" commandName="form" class="form-horizontal">
							<div class="on-down">
								...
								<div class="control-group" id="folderNameDiv">
									<label class="control-label"><span class="red">*&nbsp</span>资源文件：</label>
									<div class="controls">
										<#if form.id==null>
											<input type="file" data-validation-engine="validate[required,custom[fileFormat]]" name="upFile" id="upFile"/>
										</#if>	
										<#if form.id?? >
