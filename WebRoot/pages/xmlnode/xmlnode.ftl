...
<html xmlns="http://www.w3.org/1999/x html">
	...
	<body>
							...
							<form id="form" commandName="form" action="manager" class="form-horizontal">
								<div class="row-fluid">
									<div class="control-group span3">
										<label class="control-label" for="form-field-2">节点名称：</label>
										<div class="controls">
											<input id="query_xmlId" class="span10" onkeydown="if (13 == event.keyCode) { $('.btn-success').focus(); }" />
										</div>
									</div>
								</div>
		...
		<script type="text/javascript" src="${request.contextPath}/pages/xmlnode/xmlnode.js"></script>
		<script type="text/javascript" src="${request.contextPath}/pages/xmlnode/xmlnodeInit.js"></script>
	</body>
</html>
